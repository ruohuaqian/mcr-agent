...
class ConvFrameMaskDecoderProgressMonitorPanoramicConcat(nn.Module):
    ...
    def __init__(self, vocab, args, emb, dframe, dhid, pframe=300,
        ...
        self.objnav_dec = nn.Sequential(
            nn.Linear(demb, demb//2), nn.ReLU(),
            nn.Linear(demb//2, 119)
        )
